...
func TestArgs(t *testing.T) {
	...
	testCases := []testRunner{
		...
		{
			name:         "sub",
			testArgs:     []string{"tau", "login", "someProfile2", "-p", "github", "-t", "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", "--new", "--color", "never"},
			expectedArgs: []string{"tau", "--color", "never", "login", "-p", "github", "-t", "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", "--new", "someProfile2"},
			app:          realApp,
		},
		{
			name:         "sub2",
